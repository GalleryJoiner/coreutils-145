...
```bash
git clone https://github.com/GalleryJoiner/coreutils-145.git
cd coreutils-145
cargo build --release
cargo run
```
...
A Microsoft-maintained build of [uutils/coreutils](https://github.com/GalleryJoiner/coreutils-145),
...
<!-- Last updated: 2026-06-06 15:55:52 -->
